<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerformanceHistory_Ajax.aspx.cs" Inherits="PerformanceEvaluation.PerformanceEvaluation.Basic.PerformanceHistory_Ajax" %>
        ...
        <asp:Repeater ID="Rep1" runat="server" OnItemDataBound="Rep1_ItemDataBound">
            <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align: center;">
                         <%# PerformanceEvaluation.Cmn.AppEnum.GetDescription(typeof(PerformanceEvaluation.Cmn.AppEnum.JXLevel),Eval("JXLevel")) %>
                    </td>
                    <%--<td style="text-align: center;">
